...
[note]
Gallery format reminder: 
folderName (looks for this folder in path above)
NumberOfCards (2up, 3up, 3, 4), 4by3, 16by9, 1by1, noClick(optional - no lightbox expansion)
hero, heightPx (optional)
offset { [index, Xx, Yy, Ss] }  